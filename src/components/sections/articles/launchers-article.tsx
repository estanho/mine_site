...
export default function LaunchersArticle() {
  return (
    <>
        ...
        <Accordion type="multiple" className="w-full">
              ...
              <div className="flex flex-col space-y-4 font-roboto-sans text-pretty tracking-wide">
                ...
                <figure className="flex flex-col items-center space-y-2">
                  ...
                  <figcaption className="font-roboto-mono text-sm text-center">
                    <em>
                      Selecione a opção de <strong>Download .jar</strong> para
                      baixar o launcher.
                    </em>
                  </figcaption>
                </figure>
                ...
                <p>
                  Após baixar e executar o SKLauncher, você deve selecionar que
                  quer jogar no <strong>Modo Offline</strong> e digitar o seu
                  nick.
                </p>
                <p className="text-justify">
                  ...
                  <strong>Forge</strong>, a versão <strong>1.20.1</strong> e
                  Salvar. Assim como está representado nas imagens a seguir.
                </p>
                ...
                <figure className="flex flex-col items-center space-y-2">
                  ...
                  <figcaption className="font-roboto-mono text-sm text-center">
                    <em>
                      ...
                      <strong>Gerenciar Instalações</strong> para configurar um
                      novo perfil de instalação do Minecraft.
                    </em>
                  </figcaption>
                </figure>
                <figure className="flex flex-col items-center space-y-2">
                ...
                <p>
                  Depois de realizar essas configurações o jogo estará pronto
                  para iniciar.
                </p>
              </div>
            </AccordionContent>
          ...
          <AccordionItem value="item-original" className="px-4">
            ...
            <AccordionContent>
              <div className="flex flex-col space-y-4 font-roboto-sans text-pretty tracking-wide">
                <p>
                  Para utilizar o Minecraft Original é necessário instalar o
                  Forge <strong>47.3.33</strong> da versão{" "}
                ...
                <figure className="flex flex-col items-center space-y-2">
                  ...
                  <figcaption className="font-roboto-mono text-sm text-center">
                    <em>
                      Selecione a opção de <strong>+ Show all Versions</strong>{" "}
                      e baixe o <strong>Installer</strong> na versão 47.3.33.
                    </em>
                  </figcaption>
                </figure>
                ...
                <figure className="flex flex-col items-center space-y-2">
                  ...
                  />
                  <figcaption className="font-roboto-mono text-sm text-center">
                    <em>É necessário ter o Java Instalado para funcionar.</em>
                  </figcaption>
                </figure>

                <p className="text-justify">
                  No launcher irá aparecer uma versão do Forge 1.20.1, é só
                  selecionar e está pronto para iniciar o jogo{" "}
                  <em>(pode ser que esteja com outro nome mas está correto)</em>
                  .
                </p>
              </div>
            </AccordionContent>
